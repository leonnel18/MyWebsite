...
export default function Wisp({
  ...
  return (
    ...
    >
      {/* Varied durations + paths keep the field out of sync; flicker joins
          mid-cycle (negative delay) for instant variety. */}
      <span
        className="block"
        style={{ animation: `wisp-drift-${pathIndex} ${duration}s ease-in-out infinite` }}
      >
        <span
