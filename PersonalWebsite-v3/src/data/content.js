...
export const content = {
  ...
  about: {
    ...
    greeting: 'Hey!',
    paragraphs: [
      "I'm Gideon, a Technical Project Manager and Solutions Architect based in Metro Manila — currently driving digital enablement and distributor platforms at AXA Philippines.",
      'With 10+ years in technology and an architect\'s mindset, I transform complex data flows into seamless executions — bridging business intent and technical reality, from API contracts to AI-native deployment pipelines.',
    ],
    cta: 'Get in touch',
    ctaHref: 'mailto:gideon.valera@gmail.com',
  },
